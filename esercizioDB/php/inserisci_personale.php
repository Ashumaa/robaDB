...
<body>
    ...
    $sql = "INSERT INTO personale (matricola, nominativo, data_nascita, qualifica, stipendio, id_dip) VALUES
     ('$matricola', '$nominativo', '$data_nascita', '$qualifica','$stipendio','$id_dip')";
